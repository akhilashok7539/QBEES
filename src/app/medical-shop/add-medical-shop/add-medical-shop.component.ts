...
@Component({
  selector: 'app-add-medical-shop',
  templateUrl: './add-medical-shop.component.html',
  styleUrls: ['./add-medical-shop.component.css']
})
  ...
  submit() {
    ...
    if (this.pharmacyFormRegistration.invalid) {
     ...
     console.log(this.formData);
      ...
      this.easydealservice.addmedicalshop(this.formData).subscribe(
        data => {
          this.isLoading = false;
          this.button = 'Submit';
          console.log(data);
